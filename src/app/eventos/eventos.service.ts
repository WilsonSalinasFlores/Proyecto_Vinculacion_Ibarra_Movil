    ...
    const datos: Evento[] = [
      {
        ...
        fechaInicio: addDays(hoy, 2).toISOString(),
        fechaFin: addDays(hoy, 3).toISOString(),
        inicioPromocion: addDays(hoy, -5).toISOString(),
        finPromocion: addDays(hoy, 1).toISOString(),
      ...
      },
      {
        ...
        fechaInicio: addDays(hoy, 5).toISOString(),
        fechaFin: addDays(hoy, 5).toISOString(),
        inicioPromocion: addDays(hoy, -2).toISOString(),
        finPromocion: addDays(hoy, 4).toISOString(),
      ...
      },
      {
        ...
        fechaInicio: addDays(hoy, -1).toISOString(),
        fechaFin: addDays(hoy, -1).toISOString(),
        inicioPromocion: addDays(hoy, -10).toISOString(),
        finPromocion: addDays(hoy, -2).toISOString(),
      ...
      },
      {
        ...
        fechaInicio: addDays(hoy, 10).toISOString(),
        fechaFin: addDays(hoy, 11).toISOString(),
        inicioPromocion: addDays(hoy, 0).toISOString(),
        finPromocion: addDays(hoy, 9).toISOString(),
      ...
      },
      {
        ...
        fechaInicio: addDays(hoy, 1).toISOString(),
        fechaFin: addDays(hoy, 1).toISOString(),
        inicioPromocion: addDays(hoy, -3).toISOString(),
        finPromocion: addDays(hoy, 1).toISOString(),
      ...
      },
      {
        ...
        fechaInicio: addDays(hoy, -7).toISOString(),
        fechaFin: addDays(hoy, -7).toISOString(),
        inicioPromocion: addDays(hoy, -20).toISOString(),
        finPromocion: addDays(hoy, -8).toISOString(),
